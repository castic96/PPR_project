...
namespace kiv_ppr_network {
	...
	void Feed_Forward_Prop(TNetwork& network, const std::vector<double>& input_values, unsigned train_set_id);
	void Back_Prop(TNetwork& network, const std::vector<double>& target_values, double expected_value, unsigned train_set_id);
